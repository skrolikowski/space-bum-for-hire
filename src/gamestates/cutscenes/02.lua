...
function Cut02:enter(from, ...)
    ...
    self.timer:script(function(wait)
		...
		Scott:say('left', 'Greetings. I am Commander Scott. Second in command of the startship Senturi.', 8)
		wait(8.5)
		Scott:say('left', 'I do not wish to bore you with details so I will get right into the situation.', 8)
		wait(8.5)
		Scott:say('left', 'We are an independent research team hired to find a rare crystal on this planet.', 8)
		wait(8.5)
		Scott:worry('left', 2)
		wait(2)
		...
		Scott:worry('left', 2)
		wait(2)
		Scott:interrupt():say('left', '...and Jenny, my soon to be wife, was among them.', 8)
		wait(7)
